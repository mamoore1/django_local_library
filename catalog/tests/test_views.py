...
class AuthorCreateViewTest(TestCase):
    ...
    def test_logged_in_with_permission(self):
        ...
        # Check that it lets us access the author create page
        self.assertEqual(response.status_code, 200)

    def test_form_date_of_death_initially_has_12_10_2016(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author_create'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_redirects_to_author_page(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.post(reverse('author_create'), {'first_name': 'John', 'last_name': 'Cena'})
